...
## Clock signal;# IO_L12P_T1_MRCC_35 Sch=gclk[100]
...
################################################################
#false path
set_false_path -through [get_ports rst_pin]
set_false_path -through [get_ports LED0]
set_false_path -through [get_ports rxd_pin]
set_false_path -through [get_ports txd_pin]
set_false_path -through [get_ports LED6]
set_false_path -through [get_ports BTNL]
set_false_path -through [get_ports LED1]
set_false_path -through [get_ports LED2]
set_false_path -through [get_ports LED3]
set_false_path -through [get_ports LED4]
set_false_path -through [get_ports LED5]
set_false_path -from [get_clocks [get_clocks -of_objects [get_pins clk_wiz_inst1/inst/mmcm_adv_inst/CLKOUT0]]] -to [get_clocks clkin]
set_false_path -from [get_clocks clkin] -to [get_clocks [get_clocks -of_objects [get_pins clk_wiz_inst1/inst/mmcm_adv_inst/CLKOUT0]]]
#max fanout constraints
##################
set_multicycle_path -setup -from [get_cells {Div/Div_RobTag_reg[*]}] -to [get_cells {CDB/Cdb_RobTag_reg[*]}] 6
set_multicycle_path -hold -from [get_cells {Div/Div_RobTag_reg[*]}] -to [get_cells {CDB/Cdb_RobTag_reg[*]}] 5
set_multicycle_path -setup -from [get_cells {Div/Dividend_reg[*]}] -to [get_cells {CDB/Cdb_Data_reg[*]}] 6
set_multicycle_path -hold -from [get_cells {Div/Dividend_reg[*]}] -to [get_cells {CDB/Cdb_Data_reg[*]}] 5
set_multicycle_path -setup -from [get_cells {Div/Divisor_reg[*]}] -to [get_cells {CDB/Cdb_Data_reg[*]}] 6
set_multicycle_path -hold -from [get_cells {Div/Divisor_reg[*]}] -to [get_cells {CDB/Cdb_Data_reg[*]}] 5
set_multicycle_path -setup -from [get_cells {Div/Div_RdPhyAddr_reg[*]}] -to [get_cells {CDB/Cdb_RdPhyAddr_reg[*]}] 6
set_multicycle_path -hold -from [get_cells {Div/Div_RdPhyAddr_reg[*]}] -to [get_cells {CDB/Cdb_RdPhyAddr_reg[*]}] 5
set_multicycle_path -setup -from [get_cells Div/Div_RdWrite_reg] -to [get_cells CDB/Cdb_PhyRegWrite_reg] 6
set_multicycle_path -hold -from [get_cells Div/Div_RdWrite_reg] -to [get_cells CDB/Cdb_PhyRegWrite_reg] 5
...
#max fanout constraints
#set_property MAX_FANOUT 50 [get_cells {CDB/Cdb_RobTag_reg[*]}]
#original fanout 380
set_property MAX_FANOUT 300 [get_cells CDB/Cdb_Flush_reg]
set_property MAX_FANOUT 200 [get_cells {rob/Last_Wr_Ptr_reg[*]}]
set_property MAX_FANOUT 200 [get_cells {CDB/Cdb_RobTag_ROB_reg[*]}]
set_property MAX_FANOUT 100 [get_cells {rob/Rob_TopPtr_IntQ_reg[*]}]
set_property MAX_FANOUT 100 [get_cells {rob/Rob_TopPtr_MulQ_reg[*]}]
set_property MAX_FANOUT 100 [get_cells {rob/Rob_TopPtr_DivQ_reg[*]}]
set_property MAX_FANOUT 100 [get_cells {rob/Rob_TopPtr_LSQ_reg[*]}]



#original fanout 2300
# Switches
...
#set_property PACKAGE_PIN H17 [get_ports {Test_Success[0]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {Test_Success[0]}]
#Bank = 34, Pin name = IO_L21N_T3_DQS_34,					Sch name = LED1
#set_property PACKAGE_PIN K15 [get_ports {Test_Success[1]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {Test_Success[1]}]
#Bank = 34, Pin name = IO_L24P_T3_34,						Sch name = LED2
#set_property PACKAGE_PIN J13 [get_ports {Test_Success[2]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {Test_Success[2]}]
#Bank = 34, Pin name = IO_L23N_T3_34,						Sch name = LED3
#set_property PACKAGE_PIN N14 [get_ports {Test_Success[3]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {Test_Success[3]}]
#Bank = 34, Pin name = IO_L12P_T1_MRCC_34,					Sch name = LED4
#set_property PACKAGE_PIN R18 [get_ports {Test_Success[4]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {Test_Success[4]}]
#Bank = 34, Pin name = IO_L12N_T1_MRCC_34,					Sch	name = LED5
#set_property PACKAGE_PIN V17 [get_ports {Test_Success[5]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {Test_Success[5]}]
...
set_property PACKAGE_PIN T15 [get_ports LED6]
set_property IOSTANDARD LVCMOS33 [get_ports LED6]
#Bank = 34, Pin name = IO_L7N_T1_34,						Sch name = LED10
set_property PACKAGE_PIN U14 [get_ports LED5]
set_property IOSTANDARD LVCMOS33 [get_ports LED5]
#Bank = 34, Pin name = IO_L17P_T2_34,						Sch name = LED11
set_property PACKAGE_PIN T16 [get_ports LED4]
set_property IOSTANDARD LVCMOS33 [get_ports LED4]
#Bank = 34, Pin name = IO_L13N_T2_MRCC_34,					Sch name = LED12
set_property PACKAGE_PIN V15 [get_ports LED3]
set_property IOSTANDARD LVCMOS33 [get_ports LED3]
#Bank = 34, Pin name = IO_L7P_T1_34,						Sch name = LED13
set_property PACKAGE_PIN V14 [get_ports LED2]
set_property IOSTANDARD LVCMOS33 [get_ports LED2]
#Bank = 34, Pin name = IO_L15N_T2_DQS_34,					Sch name = LED14
set_property PACKAGE_PIN V12 [get_ports LED1]
set_property IOSTANDARD LVCMOS33 [get_ports LED1]
#Bank = 34, Pin name = IO_L15P_T2_DQS_34,					Sch name = LED15
set_property PACKAGE_PIN V11 [get_ports LED0]
...
connect_debug_port u_ila_0/probe0 [get_nets [list {SB_DataDmem[0]} {SB_DataDmem[1]} {SB_DataDmem[2]} {SB_DataDmem[3]} {SB_DataDmem[4]} {SB_DataDmem[5]} {SB_DataDmem[6]} {SB_DataDmem[7]} {SB_DataDmem[8]} {SB_DataDmem[9]} {SB_DataDmem[10]} {SB_DataDmem[11]} {SB_DataDmem[12]} {SB_DataDmem[13]} {SB_DataDmem[14]} {SB_DataDmem[15]} {SB_DataDmem[16]} {SB_DataDmem[17]} {SB_DataDmem[18]} {SB_DataDmem[19]} {SB_DataDmem[20]} {SB_DataDmem[21]} {SB_DataDmem[22]} {SB_DataDmem[23]} {SB_DataDmem[24]} {SB_DataDmem[25]} {SB_DataDmem[26]} {SB_DataDmem[27]} {SB_DataDmem[28]} {SB_DataDmem[29]} {SB_DataDmem[30]} {SB_DataDmem[31]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe1]
set_property port_width 6 [get_debug_ports u_ila_0/probe1]
connect_debug_port u_ila_0/probe1 [get_nets [list {SB_AddrDmem[2]} {SB_AddrDmem[3]} {SB_AddrDmem[4]} {SB_AddrDmem[5]} {SB_AddrDmem[6]} {SB_AddrDmem[7]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe2]
set_property port_width 1 [get_debug_ports u_ila_0/probe2]
connect_debug_port u_ila_0/probe2 [get_nets [list DCE_WriteDone0]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe3]
set_property port_width 1 [get_debug_ports u_ila_0/probe3]
connect_debug_port u_ila_0/probe3 [get_nets [list Send_DataBack_reg_n_0]]
